...
export function MenuLateral() {
  ...
  return (
    <aside
      id="default-sidebar"
      className="fixed mt-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0"
      aria-label="Sidebar"
    >
      <div className="h-full px-3 py-32 overflow-y-auto bg-blue-300 dark:bg-gray-800">
        <ul className="space-y-2 font-medium">
          ...
          <li>
            <Link href="/principal/sapatos" className="flex items-center p-2">
              <span className="h-5 text-gray-600 text-2xl">
                <FaShoePrints />
              </span>
              <span className="ms-2 mt-1">Cadastro de Tênis</span>
            </Link>
          </li>
          {/* <li>
